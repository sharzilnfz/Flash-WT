...
- [x] The shallow command modules `crates/wt-cli/src/commands/remove.rs`, `crates/wt-cli/src/commands/sweep.rs`, and `crates/wt-cli/src/commands/migrate.rs` are deleted and their dispatch is consolidated
