...
- [x] Grace period (`FLASHWT_GC_GRACE`, default 15m) gates all collection
- [x] `FLASHWT_TIMING=1` emits `flashwt-stage <name>=<ms>` lines for ingest / references / materialize / total
