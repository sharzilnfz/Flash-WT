...
//! store mirrors, mark-and-sweep, LRU snapshot retention cap, and lease sweeping.
...
// =========================================================================
// Store-Local Mark-and-Sweep (from gc_mirror.rs)
// =========================================================================
...
fn git_dir_of(wt_root: &Path) -> PathBuf {
...
// =========================================================================
// LRU Snapshot Retention Cap (from gc_snapshot_cap.rs)
// =========================================================================
...
fn invalid_cap_value_fails_loudly_like_other_wt_knobs() {
    ...
    assert!(!swept.status.success());
    let stderr = String::from_utf8_lossy(&swept.stderr);
    assert!(stderr.contains("WT_SNAPSHOT_CAP"));
}
...
fn invalid_max_snapshot_bytes_value_fails_loudly() {
    ...
    assert!(!swept.status.success());
    let stderr = String::from_utf8_lossy(&swept.stderr);
    assert!(stderr.contains("WT_MAX_SNAPSHOT_BYTES"));
}

// =========================================================================
// Automated Sandbox Lease Sweeping (from lease_sweep.rs)
// =========================================================================
