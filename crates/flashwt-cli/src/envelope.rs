...
impl<T: Serialize> Envelope<T> {
    pub fn ok(command: impl Into<String>, data: T, diagnostics: Vec<Diagnostic>) -> Self {
        Self {
            flashwt_version: env!("CARGO_PKG_VERSION").to_string(),
...
pub struct DoctorEnvVars {
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_store: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_snapshots: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_snapshots_v2: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_verify: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_timing: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_gc_grace: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_snapshot_cap: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_max_snapshot_bytes: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_hardlink: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_no_hardlink: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_tiny_bypass: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub flashwt_no_tiny_bypass: Option<String>,
}
...
pub struct DemoData {
    ...
    pub flashwt_hydration_duration_ms: u64,
...
mod tests {
    ...
    fn scratch_envelope_ok_serialization() {
        let data = ScratchData {
            worktree_path: "/tmp/flashwt-scratch-demo".into(),
    ...
    fn envelope_ok_serialization() {
        let data = CreateData {
            worktree_path: "/tmp/flashwt-demo".into(),
            branch: "demo".into(),
            cache_hit: true,
            duration_ms: 42,
            hydration_method: "clone".into(),
    ...
    fn doctor_envelope_ok_serialization() {
        let data = DoctorData {
            ...
            env_vars: DoctorEnvVars {
                flashwt_store: Some("/tmp/store".into()),
                flashwt_snapshots: Some("1".into()),
                flashwt_snapshots_v2: None,
                flashwt_verify: None,
                flashwt_timing: None,
                flashwt_gc_grace: Some("15m".into()),
                flashwt_snapshot_cap: None,
                flashwt_max_snapshot_bytes: None,
                flashwt_hardlink: None,
                flashwt_no_hardlink: None,
                flashwt_tiny_bypass: None,
                flashwt_no_tiny_bypass: None,
            },
    ...
    fn demo_envelope_ok_serialization() {
        let data = DemoData {
            ...
            flashwt_hydration_duration_ms: 15,
            speedup_ratio: 13.33,
            hydration_method: "clone".into(),
    ...
    fn incremental_decision_fields_serialized_when_present() {
        let data = CreateData {
            worktree_path: "/tmp/flashwt-incr".into(),
    ...
    fn init_envelope_ok_serialization() {
        let data = InitData {
            manifest_path: "/tmp/repo/.flashwtinclude".into(),
            created: true,
        };
        ...
        assert_eq!(parsed["status"], "ok");
        assert_eq!(parsed["data"]["manifest_path"], "/tmp/repo/.flashwtinclude");
    ...
    fn lease_envelope_ok_serialization() {
        let entry = LeaseEntry {
            ...
            is_expired: false,
            worktree_path: Some("/tmp/flashwt/repo-scratch-demo1".into()),
        ...
        assert_eq!(
            ...
            "/tmp/flashwt/repo-scratch-demo1"
        );
    ...
    fn create_envelope_resumed_serialization() {
        let data = CreateData {
            ...
            copy_fallback_reason: None,
            resumed: Some(true),
            receipt_path: Some("/tmp/repo/.git/worktrees/demo/flashwt-receipt.json".into()),
        };
        let env = Envelope::ok("create", data, vec![]);
        let json = serde_json::to_string(&env).expect("serialize");
        assert!(!json.contains('\n'));
        ...
        assert_eq!(
            ...
            "/tmp/repo/.git/worktrees/demo/flashwt-receipt.json"
        );
    }
}
